...
Integration testing using {phantomjs}[http://phantomjs.org/download.html]. You should remember about adding localization of phantomjs bin directory to your PATH.
