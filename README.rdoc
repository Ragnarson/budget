...
Application is created under an internship in a {Ragnarson}[http://ragnarson.com] company. Source code is provided under {MIT license}[https://github.com/Ragnarson/budget/blob/master/LICENSE].
...
== Team
==== Mentors
* Michał Kwiatkowski (michalk@ragnarson.com)
* Oskar Szrajera (gotar@ragnarson.com)
==== Apprentices
* Karolina Kruk (karolina.anna.kruk@gmail.com)
* Marcin Brzeziński (marcin.brzezinski.inf@gmail.com)
* Dawid Milewski (dawidmilewski89@gmail.com)
* Sebastian Wesołowski (seba.wesol@gmail.com)
* Maciej Małecki (smt116@gmail.com)
...
== License
The project is licensed under the "MIT license", for the exact terms please see the {license file}[https://github.com/Ragnarson/budget/blob/master/LICENSE].
